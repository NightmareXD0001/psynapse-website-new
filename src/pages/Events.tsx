      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Our <span className="text-psynapse">Event</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Join us for the most anticipated psychological showcase of the year
          </p>
          ...
          {events.map((event) => (
            <GlassCard key={event.id} className="p-8 hover:scale-105 transition-transform duration-500 max-w-2xl w-full">
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-gradient-to-r from-psynapse to-purple-400 flex items-center justify-center font-bold text-2xl text-white mx-auto mb-6 shadow-lg shadow-psynapse/30">
                  MEP
                </div>
                
                <h3 className="text-3xl font-bold text-psynapse mb-4">
                  {event.title}
                </h3>
                
                <p className="text-psynapse/80 text-lg mb-4">
