      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Our <span className="text-matrix">Event</span>
          </h1>
          ...
          {events.map((event) => (
            <GlassCard key={event.id} className="p-8 hover:scale-105 transition-transform duration-500 max-w-2xl w-full">
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-gradient-to-r from-matrix-400 to-matrix-500 flex items-center justify-center font-bold text-2xl text-black mx-auto mb-6 shadow-lg shadow-matrix/30">
                  MEP
                </div>
                
                <h3 className="text-3xl font-bold text-matrix mb-4">
                  {event.title}
                </h3>
                
                <p className="text-matrix/80 text-lg mb-4">
