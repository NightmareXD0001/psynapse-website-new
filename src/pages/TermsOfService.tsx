      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            <span className="text-matrix">Terms of Service</span>
          </h1>
        ...
        <div className="space-y-6">
          {termsData.content.map((section, index) => (
            <GlassCard key={index} className="p-8">
              <h2 className="text-xl font-bold text-matrix mb-4">{section.heading}</h2>
        ...
        <GlassCard className="p-8 mt-8 text-center">
          <p className="text-gray-400">
            ...
            <a href="/contact" className="text-matrix hover:underline">
              contact us
            </a>
          </p>
        </GlassCard>
